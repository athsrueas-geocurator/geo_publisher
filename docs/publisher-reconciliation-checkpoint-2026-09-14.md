...
| 5. Technopoly / profile | Absent after adequate discovery; publication queued | Fresh complete all-space exact-title searches have no candidates. Open Library work `OL137911W`, existing Neil Postman Person `0373f5e944d94ebf8c74ce87c01623eb`, Book type `8864304115334498b8ea6c1ae833628e`, and Authors relation `91a9e2f6e51a48f7997661de8561b690` are verified; see `data/book-curation/technopoly-discovery-2026-09-14.json`. Existing post `fd024e4f126343af98c61c32ae6f917e` must retain its text. | Refresh title and identifier discovery with Books authority immediately before an authorized create, then prepare a sourced work-level Book and one relation to the post. No editorial copy. |
