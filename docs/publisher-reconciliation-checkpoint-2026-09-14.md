...
| 7. Space icons | Existing pages; Avatar mapping absent in scoped reader | Education page `16a032fb91794444859a6c1a44a32955` and Public good page `789068315729430884b1bff0dc9ac39b` have no verified Avatar relation in the current reader. Cover is not an icon substitute. | Discover a comparable space's Avatar relation and Image URL property, then report the verified schema and reusable image IDs. This polish does not block substantive packages. |
